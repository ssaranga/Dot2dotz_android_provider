package com.dot2dotz.provider.Services;
...
import com.dot2dotz.provider.FloatingViewService.FloatingViewListener;
import com.dot2dotz.provider.FloatingViewService.FloatingViewManager;
...
public class CustomFloatingViewService extends Service implements FloatingViewListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        ImageView iconView =  mFloatingView.findViewById(R.id.collapsed_iv);
        ImageView close_btn =  mFloatingView.findViewById(R.id.close_btn);
        ...
        mFloatingView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    //Changed due to Crash 30-11-2018
                    Intent intent = new Intent(CustomFloatingViewService.this, MainActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                    onFinishFloatingView();
