...
import com.dot2dotz.provider.Utilities.CircularProgressBar;
...
public class EarningsFragment extends Fragment {
    ...
    public void getEarningsList() {
        ...
        Log.e("URL: ", URLHelper.TARGET_API);
...
//                        custom_progressBar.setProgress(Integer.parseInt(response.optString("rides_count")));
    ...
    public void GoToBeginActivity() {
        Intent mainIntent = new Intent(activity, SignIn
                .class);
    ...
    private class EarningsAdapter extends RecyclerView.Adapter<EarningsAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            try {
                ...
                holder.lblDistance.setText(jsonObject.optString("distance") + " mi");
