...
import com.dot2dotz.provider.Bean.Connect;
import com.dot2dotz.provider.Dot2dotzApplication;
import com.dot2dotz.provider.Fragment.EarningsFragment;
import com.dot2dotz.provider.Fragment.Help;
import com.dot2dotz.provider.Fragment.Map;
import com.dot2dotz.provider.Fragment.SummaryFragment;
import com.dot2dotz.provider.Helper.SharedHelper;
import com.dot2dotz.provider.Helper.URLHelper;
import com.dot2dotz.provider.Listeners.ConnectionBooleanChangedListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG_YOURTRIPS = "yourdeliveries";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utilities.setLanguage(MainActivity.this);
        findViewById();
    ...
    private void setUpNavigationView() {
        navigationView.getMenu().findItem(R.id.nav_yourtrips).setTitle(R.string.your_trips);
        navigationView.getMenu().findItem(R.id.nav_earnings).setTitle(R.string.earnings);
        navigationView.getMenu().findItem(R.id.nav_wallet).setTitle(R.string.summary);
        navigationView.getMenu().findItem(R.id.nav_manage_document).setTitle(R.string.manage_document);
        navigationView.getMenu().findItem(R.id.nav_settings).setTitle(R.string.settings);
        navigationView.getMenu().findItem(R.id.nav_help).setTitle(R.string.help);
        navigationView.getMenu().findItem(R.id.nav_share).setTitle(R.string.share);
        navigationView.getMenu().findItem(R.id.nav_logout).setTitle(R.string.logout);
...
//                        GoToFragment();
                    ...
                    case R.id.nav_logout:
                        ...
                        showLogoutDialog();
                        return true;
                    case R.id.nav_manage_document:
                        drawer.closeDrawers();
                        Intent docIntent = new Intent(MainActivity.this, ManageDocumentActivity.class);
                        docIntent.putExtra("ProviderId", SharedHelper.getKey(MainActivity.this, "provider_id"));
