            ...
            public void onResponse(JSONObject response) {
                if (response != null) {
                    try {
                        ...
                        if (response.has("service") && response.optJSONObject("service").optString("status").equalsIgnoreCase("active")) {
...
//                            context.startActivity(intent);
                            ...
                            //Show error message
                            Toast.makeText(getActivity(), "" + response.optString("error").toString(), Toast.LENGTH_SHORT).show();
                        } else {
