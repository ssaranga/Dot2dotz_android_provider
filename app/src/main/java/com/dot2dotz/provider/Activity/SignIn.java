...
public class SignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mint.initAndStartSession(this.getApplication(), "ba07b186");

        setContentView(R.layout.activity_begin_signin);
        Utilities.setLanguage(SignIn.this);
        generateHashKey();
...
*/
        ...
        lnrRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SharedHelper.putKey(getApplicationContext(), "from", "mobile");
                SharedHelper.putKey(getApplicationContext(), "mobile", "" + txtemail.getText().toString());
            ...
            public void onClick(View view) {
                try {
                    ...
                    displayMessage(getString(R.string.not_valid_email));
                        ...
                        SharedHelper.putKey(thisActivity, "mobile", txtemail.getText().toString());
                                ...
                                public void onSuccess(LoginResult loginResult) {
                                    ...
                                    *//*GraphRequest request = GraphRequest.newMeRequest(
                                    ...
                                    if (AccessToken.getCurrentAccessToken() != null) {
                                        ...
                                        SharedHelper.putKey(SignIn.this, "accessToken", loginResult.getAccessToken().getToken());
    ...
    private void signIn() {
        if (isInternet) {
            ...
            try {
                ...
                object.put("mobile", txtemail.getText().toString());
...
//                imgProfile.setImageBitmap(bitmap);
    ...
    public void generateHashKey() {
        PackageInfo info;
        try {
            info = getPackageManager().getPackageInfo("com.dot2dotz.provider", PackageManager.GET_SIGNATURES);
            for (Signature signature : info.signatures) {
                MessageDigest md;
